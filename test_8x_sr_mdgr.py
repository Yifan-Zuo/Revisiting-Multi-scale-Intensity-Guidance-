...
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/table2/_input/"+data_name+"_big/depth_3_n.png")###mid 2006
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/iccv15_test_imgs/input/"+data_name+"/8_x_dep.png")###mid 2001
...
dep_8x_ten=bnb.LR_dep_feature_extraction(LR_depth_batch_input)
dep_8x_ten_up=bnb.feature_up_unit(dep_8x_ten,3)
dep_4x_ten=bnb.LR_dep_fusion(dep_8x_ten_up[0],inten_4x_down,fusion_stage=1)
dep_4x_ten_up=bnb.feature_up_unit(dep_4x_ten,2)
dep_2x_ten=bnb.LR_dep_fusion(tf.concat([dep_8x_ten_up[1],dep_4x_ten_up[0]],3),tf.concat([inten_4x_down_up[0],inten_2x_down],3),fusion_stage=2)
dep_2x_ten_up=bnb.feature_up_unit(dep_2x_ten,1)
dep_ten=bnb.LR_dep_fusion(tf.concat([dep_8x_ten_up[2],dep_4x_ten_up[1],dep_2x_ten_up[0]],3),tf.concat([inten_4x_down_up[1],inten_2x_down_up[0],inten_1x_ten],3),fusion_stage=3)
HR_gen_dep=bnb.LR_dep_reconstruction(dep_8x_ten_up[2],dep_ten,coar_inter_dep_batch)
...
with tf.Session() as sess:
    model_path="/media/kenny/Data/trained_models/multi_dense_guide_resnet/noise_free/l1loss/8x/full_model3/8x_nf_full_model.ckpt-31"
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/multi_dense_guide_resnet/noise-free/l1loss/8x/results/"+data_name+"8x_result.png")
    ######################computing rmse
