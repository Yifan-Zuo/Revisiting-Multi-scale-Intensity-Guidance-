...
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/table2/_input/"+data_name+"_big/depth_2_n.png")###mid 2006
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/iccv15_test_imgs/input/"+data_name+"/4_x_dep.png")###mid 2001
...
dep_ten=bnb.LR_dep_fusion(tf.concat([dep_4x_ten_up[1],dep_2x_ten_up[0]],3),tf.concat([inten_2x_down_up[0],inten_1x_ten],3),fusion_stage=2)
HR_gen_dep=bnb.LR_dep_reconstruction(dep_4x_ten_up[1],dep_ten,coar_inter_dep_batch)
...
with tf.Session() as sess:
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/multi_dense_guide_resnet/noise-free/l1loss/4x/results/"+data_name+"4x_result.png")
    ######################computing rmse
