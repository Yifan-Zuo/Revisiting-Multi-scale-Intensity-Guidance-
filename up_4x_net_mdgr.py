    ...
    with tf.Session() as sess:
        ...
        for epo in range(epo_range):
            ...
            for ind in range(batch_total):
                ...
                if (ind+1)%7656==0:
                    save_path=saver_full.save(sess,"/media/kenny/Data/trained_models/multi_dense_guide_resnet/noise-free/l1loss/4x/full_model1/4x_nf_full_model.ckpt",global_step=model_ind)
