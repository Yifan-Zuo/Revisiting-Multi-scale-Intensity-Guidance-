...
LR_dep_art=Image.open("/media/kenny/Data/test_data/noise_free/middlebury_bicubic_LR_test_pairs/"+data_name+"/"+data_name+"2x_bicubic.png")#####for noise-free midd2006
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/table2/_input/"+data_name+"_big/depth_1_n.png")###mid 2006
#LR_dep_art=Image.open("/media/kenny/Data/test_data/noisy/iccv15_test_imgs/input/"+data_name+"/2_x_dep.png")###mid 2001
...
with tf.Session() as sess:
    ...
    #result_img.show()
    result_img.save("/media/kenny/Data/trained_models/multi_dense_guide_resnet/noise-free/l1loss/2x/results/"+data_name+"2x_result.png")
    ######################computing rmse
